...
<template>
  <PartialsSection component-name="action-button" description="Un botón para ejecutar acciones capaz de manejar confirmación y errores." title="Boton de acción" :dependencies="['vue-sonner']" :registry-dependencies="['button', 'spinner', 'dialog', 'sonner']">
    <template #example>
